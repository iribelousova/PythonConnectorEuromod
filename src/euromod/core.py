...
class Model(Euromod_Element):
    ...
    countries : :obj:`str`, or :obj:`Container` [ :obj:`str` ], optional
    ...
    def __init__(self, model_path : str):
        ...
        """
        errors = SystemCs.Collections.Generic.List[SystemCs.String]()
        emPath = EMPath(model_path,False)
        if not os.path.exists(emPath.GetExtensionsFilePath(False)) & os.path.exists(model_path):
...
class Country(Euromod_Element):
    ...
    def get_switch_value(self,ext_name : Optional[str] = None,dataset_name : Optional[str] = None,sys_name : Optional[str] = None):
        ...
        ext_name : :obj:`str` , optional
            Name of the extension. The default is :obj:`None`.
        dataset_name : :obj:`str` , optional
            Name of the dataset. The default is :obj:`None`.
        sys_name : :obj:`str` , optional
            Name of the system. The default is :obj:`None`.
        ...
        core.ExtensionSwitch 
            Object of the type :obj:`ExtensionSwitch` containing information how the switch is configured.
...
class ExtensionSwitch(Euromod_Element):
    ...
    def __init__(self,info,ctry):
        ...
        self.extension_name = ctry.extensions._get_by_id(info[TAGS.EXTENSION_ID]).shortName
        """: Short name of the extension"""
        self.sys_name = ctry.systems._get_by_id(info[TAGS.SYS_ID]).name
        """: Name of the applicable system"""
        self.data_name = ctry.datasets._get_by_id(info[TAGS.DATA_ID]).name
...
class System(Euromod_Element):   
    ...
    def run(self,data: pd.DataFrame,dataset_id: str,constantsToOverwrite: Optional[Dict[Tuple[str, str], str]] = None,verbose: bool = True,outputpath: str = "",  addons: List[Tuple[str, str]] = [],  switches: List[Tuple[str, bool]] = [],nowarnings=False,euro=False,public_components_only=False):
        ...
        euro : :obj:`bool`, optional
            If True then the monetary variables in the output will be converted to euro. Default value is :obj:`False`.
        public_compoments_only : :obj:`bool`, optional
            If True then the the model will be on with only the public compoments. Default value is :obj:`False`.
        Raises
        ------
        Exception
...
class ParameterInSystem(SystemElement):
    ...
    extensions: list # Container[Extension]
    """: A :obj:`Container` with :class:`Extension` objects."""
    ID: str
    """Identifier number of the parameter."""
    comment: str
