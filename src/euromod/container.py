...
class Container:
    ...
    def find(self,key,pattern,return_children=False,case_insentive=True):
        ...
        return_children : :obj:`bool`, optional
            When True, the return type will be a :obj:`Container` containing elements of the type for which the find method was used
        ...
        case_insentive : :obj:`bool`, optional
            When false, perform case-insensitive matching. The default is :obj:`True`.
