...
Please, refer to the `User Guide`_ and `Examples`_ for futher readings.

.. toctree::
   :titlesonly:

   /autoapi/euromod/index
...
.. _User Guide: ..docs/notebooks/userguide.ipynb
.. _Examples: ..docs/notebooks/example.ipynb